...
**ISA Instruction-level Architecture**: programmer visible instruction set. Boundary between software and hardware. 
...
The best choice of benchmarks to measure performance is real applications, common pitfalls:
